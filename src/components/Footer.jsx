...
export default function Footer() {
  return (
    <footer className="bg-brand-off-white text-brand-dark-2 pt-20 pb-10 border-t border-gray-200 relative overflow-hidden">
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            />
            <p className="text-brand-dark-2/60 text-base leading-relaxed max-w-sm mb-6">
          ...
          <div>
            <h4 className="font-bold text-lg uppercase mb-6 text-brand-dark-2">Contact</h4>
            <ul className="flex flex-col gap-4 text-brand-dark-2/60 text-base">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:s.raphael@methodestephanieraphael.com" className="hover:text-brand-orange transition-colors">s.raphael@methodestephanieraphael.com</a>
              </li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-lg uppercase mb-6 text-brand-dark-2">Légal</h4>
            <ul className="flex flex-col gap-3 text-brand-dark-2/60 text-base">
            ...
            <p className="mt-6 text-xs uppercase tracking-[1px] font-bold text-brand-dark-2/30 border-t border-gray-200 pt-4">
              N° Formation: 11 92 29538 92
            </p>
          </div>
        </div>

        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-200 text-brand-dark-2/40 text-xs font-bold uppercase tracking-[1px]">
          <p>© {new Date().getFullYear()} Méthode Stéphanie Raphaël. Tous droits réservés.</p>
          <p className="mt-4 md:mt-0">64 avenue Pierre Grenier · 92100 Boulogne-Billancourt</p>
        </div>
      </div>
    </footer>
  );
