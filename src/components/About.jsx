...
function AnimatedNumber({ value, suffix = '', duration = 1.5 }) {
  ...
  return (
    <span ref={ref} className="block font-bold text-[2rem] text-brand-orange leading-none mb-1">
      {display}{suffix}
    </span>
  );
}
...
export default function About() {
  return (
    <section className="py-16 md:py-20 bg-brand-off-white relative overflow-hidden" id="stephane">
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            {/* Stats under the photo — centered with the image */}
        ...
        >
          <span className="tag mb-4 block">La parole à Stéphanie</span>
          <h3 className="font-bold text-[clamp(1.5rem,2.5vw,2rem)] uppercase leading-tight mb-8">
